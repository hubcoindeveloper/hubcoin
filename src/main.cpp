...
int64 nChainStartTime = 1479888000;
...
const string strMessageMagic = "HubCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "HubCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "http://www.coinsoda.org/coin=1003";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = nChainStartTime + 33;
        ...
        assert(block.hashMerkleRoot == uint256("0x8e2c819ec0369ef12773309d62bbf6ac18b16bcf7a953436cdcba5c1b30fa950"));
